#include "stdafx.h"
#include "lightDependlit.h"
#include "spheregeom.h"
#include <cmath>

void lightDependLit::CreateGeometry(const GeometryHelper& geometry)
{
	// load the shader program
	shader = new SOF::ShaderProgram("shaders/v_earthLit.glsl", "shaders/f_earthLit.glsl");
...
void lightDependLit::Draw(const Transforms& trans, const PointLight& light)
{
	...
	shader->AssignTextureSampler("texture1", texture1);
	shader->AssignTextureSampler("texture2", texture2);
